...
| [`BACKLOG_RU.md`](BACKLOG_RU.md) | тот же бэклог на русском |
| [`REVIEW_2026_08_09.md`](REVIEW_2026_08_09.md) | ревью ветки: 18 дефектов, чем каждый грозил и как исправлен |
| [`REVIEW_2026_08_12.md`](REVIEW_2026_08_12.md) | ревью `lateral_improvements`: 220 файлов, что изменилось и почему |
| [`REVIEW_UNCOMMITTED.md`](REVIEW_UNCOMMITTED.md) | ревью набора перед коммитом: 15 находок, что каждая ломала и как закрыта |
| [`MERGE_REQUEST.md`](MERGE_REQUEST.md) | описание ветки целиком: шесть коммитов, что сделано, что измерено, что осталось открытым |
| [`../CHANGELOG.md`](../CHANGELOG.md) | что вошло в релиз. Сюда же переехала история завершённых задач из бэклога |

## Состояние кода

Не про поведение системы, а про сам код: что стоит убрать, сократить или починить.

| | |
|---|---|
| [`CLANG_TIDY_2026_08_15.md`](CLANG_TIDY_2026_08_15.md) | статический анализ: находки по файлам с приоритетами, что уже исправлено. Как запускать — [`../scripts/cpp/README.md`](../scripts/cpp/README.md) |
| [`REFACTOR_COSMETIC_2026_08_14.md`](REFACTOR_COSMETIC_2026_08_14.md) | косметика без изменения поведения: имена, раскладка файлов, единообразие |
| [`REVIEW_COMPACTION_2026_08_14.md`](REVIEW_COMPACTION_2026_08_14.md) | повторы в C++: где один и тот же расчёт написан дважды и чем это грозит |
