...
3. [`book/`](book/) — курс ([сайт](https://anatolykabakov.github.io/adas/),
   [по-русски](https://anatolykabakov.github.io/adas/ru/)). Главы устроены по образцу AAD: внутри каждой
   строится игрушка, ломается с числом в руках, и затем встречается боевая версия той же идеи; порядок
   чтения в интро — это и порядок стройки.
