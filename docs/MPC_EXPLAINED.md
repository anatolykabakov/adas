...
> Analysis of lateral controller **VisionPilot MPC** (`app/src/main/cpp/src/lateral/visionpilot_mpc.cpp`)
...
### Files
- MPC core: `app/src/main/cpp/src/lateral/visionpilot_mpc.cpp`, wrapped by `vp_planner.cpp`
- orchestration + debug publish: `app/src/main/cpp/src/services/planner.cpp`
