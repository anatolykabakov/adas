...
extern CL_API_ENTRY cl_mem CL_API_CALL clCreateBufferFromImageQCOM(cl_mem image, cl_mem_flags flags,
                                                                   cl_int* errcode_ret);
...
extern CL_API_ENTRY cl_int CL_API_CALL clSetPerfHintQCOM(cl_context context, cl_perf_hint perf_hint);
...
extern CL_API_ENTRY cl_mem CL_API_CALL clCreateFromEGLImageIMG(cl_context context, cl_mem_flags flags,
                                                               CLeglImageIMG image, CLeglDisplayIMG display,
                                                               cl_int* errcode_ret);
