...
public class ProtoUtils {
    ...
    public static BagOuterClass.Bag createBagMessage(List<Messages.ZMQMessage> zmqMessages) {
        ...
        if (!zmqMessages.isEmpty()) {
            ...
            com.google.protobuf.Timestamp timestamp =
                    com.google.protobuf.util.Timestamps.fromMillis(zmqMessages.get(0).getTimestamp());
    ...
    public static Messages.ZMQMessage createCameraIntrinsicsMessage(
            ...
            CameraIntrinsicsOuterClass.CameraIntrinsics.Source source,
            long timestamp) {
        ...
        CameraIntrinsicsOuterClass.CameraIntrinsics.Builder intrinsicsBuilder =
                CameraIntrinsicsOuterClass.CameraIntrinsics.newBuilder();
        intrinsicsBuilder.setTimestamp(timestamp);
        intrinsicsBuilder.setSource(source);
    ...
    public static Messages.ZMQMessage createLaneLinesMessage(adas.app.vision.LaneLines ll) {
        return createLaneLinesMessage(ll, /*includeModelOut=*/true);
    }

    public static Messages.ZMQMessage createLaneLinesMessage(
            adas.app.vision.LaneLines ll, boolean includeModelOut) {
        if (ll == null) {
            return null;
        }
        ...
        for (float x : adas.app.vision.LaneLines.X_IDXS) {
            lanesBuilder.addX(x);
        }
        for (int i = 0; i < 4; i++) {
    ...
    public static Messages.ZMQMessage createCameraOdometryMessage(
            long timestampMs, int frameId, adas.app.vision.CameraOdometry pose) {
    ...
    public static Messages.ZMQMessage createModelLongPlanMessage(
            long timestampMs, int frameId, adas.app.vision.ModelLongParse.Out longOut,
            adas.app.vision.CameraOdometry pose) {
    ...
    public static Messages.ZMQMessage createTrafficDetectionsMessage(
            adas.app.vision.TrafficYoloRunner.Result res, int frameId, long captureTsMs) {
        long inferTs = adas.app.TimeUtil.nowMs();
        ...
        if (res.dets != null) {
            for (adas.app.vision.TrafficYoloRunner.Det d : res.dets) {
    ...
    private static ModelLongOuter.LeadTrack toLeadTrack(adas.app.vision.ModelLongParse.Lead lead) {
