#!/usr/bin/env python3
"""Lane offset from openpilot/dragonpilot logs — same metric as `bag_arc_offset.py`.
...
* `carState` — speed, steering angle, hands on wheel.
  ...
  OPENPILOT_ROOT=/path/to/openpilot python3 rlog_arc_offset.py <route directory> --cache /tmp/rlog.npz
"""
