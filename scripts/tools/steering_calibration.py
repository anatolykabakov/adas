...
def main():
    ...
    # Next to this script. The path used to be hardcoded to a container mount point that did not
    # match how the repository is actually mounted, so --help alone failed with PermissionError.
    config_path = str(Path(__file__).resolve().parent / "steering_calibration.yml")
