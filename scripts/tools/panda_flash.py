...
Usage:
    python tools/panda_flash.py --firmware panda.bin.signed
    python tools/panda_flash.py --firmware panda_h7.bin.signed --mcu h7
    python tools/panda_flash.py --check-only  # Just check firmware version
"""
...
Examples:
  ...
  python tools/panda_flash.py --firmware /path/to/panda.bin.signed

  # Force flash even if signatures match
  python tools/panda_flash.py --firmware panda.bin.signed --force

  # Check firmware version only
  python tools/panda_flash.py --check-only
