...
0.3 секунды.
    ...
    python3 bag/bag_report.py adas_logs/2026_08_08_23_00_28
    python3 bag/bag_report.py adas_logs/A adas_logs/B --only step   # сравнение заездов
"""
...
def sec_notes(d, bag: Path, model: str):
    ...
    if not cache.exists():
        print(
            ...
            f"python3 bag/bag_voice_notes.py {bag} --model {model}"
        )
        return
